...
class EmbeddingClient:
    ...
    def embed_text(self, text: str) -> list[float]:
        ...
        # Hard truncate before sending to LiteLLM to prevent token explosion for very long queries.
        # ~16000 characters is safely within typical 8192 token window limits.
        if len(text) > 16000:
            text = text[:16000]
