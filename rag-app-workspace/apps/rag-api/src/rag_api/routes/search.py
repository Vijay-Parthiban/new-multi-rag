...
def _to_search_results(hits: list[dict[str, object]]) -> list[SearchResultResponse]:
    return [
...
async def search_points(
    ...
    """Search stored chunks (dense / sparse / hybrid). Returns structured hits only."""
    try:
        ...
        return _to_search_results(hits)
